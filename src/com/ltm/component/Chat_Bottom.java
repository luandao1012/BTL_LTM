...
import com.ltm.app.MessageType;
import com.ltm.event.PublicEvent;
import com.ltm.model.Model_Send_Message;
import com.ltm.model.Model_User_Account;
import com.ltm.service.Service;
import com.ltm.swing.JIMSendTextPane;
...
public class Chat_Bottom extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/ltm/icon/send.png")));
        ...
        cmdMore.setIcon(new ImageIcon(getClass().getResource("/com/ltm/icon/more_disable.png")));
        cmdMore.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (panelMore.isVisible()) {
                    ...
                    cmdMore.setIcon(new ImageIcon(getClass().getResource("/com/ltm/icon/more.png")));
